...
export function ERFGauge({ value }: ERFGaugeProps) {
  ...
  useEffect(() => {
    ...
    // Green zone (0.8-1.0)
    const greenStart = startAngle + totalArc * 0.8
    const greenEnd = endAngle
    ctx.beginPath()
    ctx.arc(cx, cy, radius, greenStart, greenEnd)
  ...
  return (
    <Card className="overflow-hidden border-border/50 bg-card animate-fade-in-up" style={{ animationDelay: "400ms" }}>
      ...
      <CardContent className="flex flex-col items-center pb-6">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pt-4">
            <span className="font-mono text-5xl font-bold tabular-nums" style={{ color: erfColor }}>
